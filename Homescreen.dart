...
import 'package:firebase_chat_app_with_opps/ChatPage.dart';
...
class HomescreenState extends State<Homescreen> with ForUI {
  @override
      ...
      body: guest
          ? Column(
              ...
              children: [
                Center(
                    child: Fun(
                        "You don't have an account ", 20, FontWeight.normal,
                        a: text())),
                Center(
                  child: InkWell(
                      onTap: () {
                      ...
                      child: Fun("Create New Account ", 20, FontWeight.normal,
                          a: text())),
                ),
                Center(
                  child: InkWell(
                      ...
                      child: Fun(
                          "Log in with your an account ", 20, FontWeight.normal,
                          a: text())),
                ),
              ],
            )
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: [
                              Fun(userdata['Name'].toString(), 20,
                                  FontWeight.normal,
                                  a: text()),
                              Fun(userdata['Email'].toString(), 20,
                                  FontWeight.normal,
                                  a: text()),
                            ],
                          ),
